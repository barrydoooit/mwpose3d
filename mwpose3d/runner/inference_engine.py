...
from mwpose3d.datasets.transforms import WITH_ONLINE_FUNCTIONALITY, BaseTransform
from mwpose3d.registry import MODELS, TRANSFORMS
...
class InferenceEngine:
    ...
    def _make_pipeline(self, pipeline: List[dict]) -> Tuple[BaseTransform, ...]:
        ...
        pipeline = [TRANSFORMS.build(dict(transform, online_mode=True)) for transform in pipeline]
