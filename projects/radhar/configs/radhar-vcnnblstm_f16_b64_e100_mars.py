...
pcd_dim = 5
point_cloud_range = [-0.725, 0.4, -0.5, 0.725, 2.4, 1.25]
...
model = dict(
    ...
    moddle_encoder=dict(
        ...
        encoder_paddings=((1,), ((1, 0, 1), 1), ((1, 0, 1), 1)),
...
custom_hooks = [
    dict(
        ...
        out_file="exp_data/latency/3090/radhar-vcnnblstm_f16_b64_e100_mars.json",
        subject_modules=[],
