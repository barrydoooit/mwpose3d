...
seq_frames = 5
stack_frames = 5
num_frames = past_frames + seq_frames + (stack_frames - 1)
backup_frames = 1
...
inject_stack_index = True
if inject_stack_index:
    radar_input_c += 1  # Inject stack index as an additional channel
    radar_input_c_mid += 1 
...
train_pipeline = [
    dict(
        ...
        load_pcd_dim=radar_input_c - (1 if inject_stack_index else 0),
        num_frames=seq_frames + (stack_frames - 1), # NOTE: This is for phase 1. Phase 2 will use num_frames
    ...
    dict(
        ...
        inject_index=inject_stack_index,
    ),
    dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        sequence_length=seq_frames + (stack_frames - 1) + backup_frames,
...
custom_hooks = [
    ...
    dict(
        ...
        out_file="exp_data/latency/3090/ptransv1_f5p64_b16_e10_milipoint.json",
        subject_modules=[],
